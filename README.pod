...
LacunaCookbuk was intended to be something similar to cookbuk for creating glyphs. But real life changed it to client with library that has only one implementing client. 
